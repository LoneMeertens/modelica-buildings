...
model Borefields_DFP_Glycol_T30
  ...
  .Buildings.Fluid.Sources.MassFlowSource_T sou1(
    ...
    T=303.15) "Source" annotation (Placement(transformation(extent={{-49.6,44.0},{-29.6,64.0}}, rotation=0.0,origin = {0.0,0.0})));
  ...
  .Buildings.Fluid.Sources.Boundary_pT sin1(
    ...
    nPorts=1,
    p=101330,
    T=283.15) "Sink" annotation (Placement(transformation(extent={{132.0,44.0},{112.0,64.0}}, rotation=0.0,origin = {0.0,0.0})));
